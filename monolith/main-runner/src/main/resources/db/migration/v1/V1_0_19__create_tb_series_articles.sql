...
-- Schema: series
CREATE TABLE IF NOT EXISTS "series"."series_articles" (
    "series_id"          BIGINT,
    "draft_id"           BIGINT,
...
-- 컬럼 코멘트
COMMENT ON COLUMN "series"."series_articles"."user_sort_order"     IS '사용자정렬순서';
COMMENT ON COLUMN "series"."series_articles"."created_at"          IS '생성시간';
COMMENT ON COLUMN "series"."series_articles"."updated_at"          IS '마지막 수정시간';
